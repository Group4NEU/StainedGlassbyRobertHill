    ...
    <div id="<?php print $rand; ?>">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-10">
                <div class="form-group">
                    <label for="address" class="col-xs-12 col-sm-6 col-md-2 control-label"><?php _e("Address"); ?></label>
            ...
            <div class="col-xs-12 col-md-10">
                <div class="form-group">
                    <label for="note" class="col-xs-12 col-sm-6 col-md-2 control-label"><?php _e("Note"); ?></label>
                    <div class="col-xs-12 col-sm-6 col-md-10">
